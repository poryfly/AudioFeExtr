...
#define FE_CEP_ORDER           14 /* Number of cepstral coefficients is CEPORDER+1 including c0 */
#define FE_CEP_ORDER_ADD1      15
...
int hffcoef(double* frameA, int frameSize, double *hffc_cep, int ceporder, int fft_size,int sampleRate, double *filtMig,uintptr_t ffthandle);
float LogE(float x);
